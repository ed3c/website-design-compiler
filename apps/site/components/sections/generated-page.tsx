...
function content(node:CompletePageGraph["nodes"][number]){
...
export function GeneratedPage({graph}: {graph:CompletePageGraph}){
  return <main className="wdc-shell" data-generated-page={graph.category} data-page-readiness={graph.readiness} data-graph-signature={graph.signature}>
    <header className="wdc-hero">
      ...
      <p>Rendered directly from the governed page graph with semantic order, responsive, motion and media contracts attached to each node.</p>
    </header>
