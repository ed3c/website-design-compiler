...
function reportedAdapterInfo(value: string | undefined): string {
  const reported = value?.trim();
  return reported ? reported : "UNREPORTED";
}
      ...
      try {
        ...
        onReady({
          ...
          identity: {
            ...
            tslModule: "three/tsl@0.184.0",
            adapterInfo: {
              vendor: reportedAdapterInfo(adapterInfo.vendor),
              architecture: reportedAdapterInfo(adapterInfo.architecture),
              device: reportedAdapterInfo(adapterInfo.device),
              description: reportedAdapterInfo(adapterInfo.description)
            },
