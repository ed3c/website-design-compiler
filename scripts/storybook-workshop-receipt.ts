...
const sectionProjections=Array.isArray(sectionProjectionValue)&&sectionProjectionValue.every((entry)=>entry&&typeof entry==="object"&&typeof (entry as SectionProjection).kind==="string"&&typeof (entry as SectionProjection).storyId==="string")?sectionProjectionValue as SectionProjection[]:[];
