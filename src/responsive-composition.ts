...
export interface ResponsiveSectionPolicy {
  kind:SectionKind;
  semanticOrder:"DOM_STABLE";
  mobile:ViewportComposition;
  tablet:ViewportComposition;
  desktop:ViewportComposition;
  coarsePointer:{hoverRequired:false; carousel:"controls"|"static"; sticky:boolean};
  reducedMotion:{essentialOnly:true; transition:"instant"|"short"};
  degradation:{maxDprMobile:1.5; graphics2d:"static-poster"|"progressive"; graphics3d:"static-poster"|"progressive"; media:"poster-first"|"normal"};
}
